            ...
            {totalPrice !== null && (
              <>
                ...
                <div className="pin-display">
                  ...
                  <p>{pin}</p>
                  <h2 style={{ color: "red"}}>Save this Pin or take a screenshot of it as your access may be lost if you lose your pin</h2>
                </div>
              </>
            )}
            <div className="calendar-container">
              <div className="text-center">
                <p>Book your access</p>
                <span style={{ color: "#c5f801", fontSize: "14px", marginBottom: "10px"}}>{ currentAccountId }</span>
                <button id="bookbut" type="submit">Add Booking</button>
              </div>
            </div>
          </form>
        </div>
